...
/* This file was automatically generated Wed Apr 24 10:46:17 2013 UTC */
...
#define BOTAN_HAS_ENGINE_AMD64_ASSEMBLER
#define BOTAN_HAS_ENGINE_SSE2_ASSEMBLER
...
#define BOTAN_HAS_TIMER_HARDWARE
...
/*
root@IZP ran './configure.py'

Target
-------
Compiler: g++ -m64 -O2 -finline-functions 
Arch: amd64/amd64
OS: linux
...
amd64_eng (AMD64 Assembler Engine)
arc4 (ARC4)
asm_amd64 (Assembler Macros (x86-64))
...
serpent (Serpent)
sha1 (SHA-1)
sha1_amd64 (SHA-1 (x86-64 assembler))
sha1_sse2 (SHA-1 (SSE2))
sha2 (SHA-2 (224, 256, 384, 512))
skein (Skein)
skipjack (Skipjack)
square (Square)
sse2_eng (SSE2 Assembler Engine)
ssl3mac (SSLv3 MAC)
ssl_prf (SSLv3 PRF)
